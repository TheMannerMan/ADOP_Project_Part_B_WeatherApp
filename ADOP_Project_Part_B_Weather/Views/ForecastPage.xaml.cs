...
namespace ADOP_Project_Part_B_Weather.Views
{
    ...
    public partial class ForecastPage : ContentPage
    {
        ...
        private async void Button_Clicked(object sender, EventArgs e)
        {
            ...
            aiActivityIndicator.IsRunning = true;
            aiActivityIndicator.IsVisible = true;
            try
            {
                await LoadForecast();
            }
                ...
                aiActivityIndicator.IsRunning = false;
                aiActivityIndicator.IsVisible = false;
            }
        }
        ...
        private async Task LoadForecast()
        {
            ...
            var groupedForecast = forecast.Items.GroupBy(item => item.DateTime).ToList();
